...
namespace BankAccountApp
{
    ...
    {
        private readonly BankAccount checking;
        private readonly BankAccount savings;
        ...
        private void UpdateAccountInfo()
        {
            if (InvokeRequired)
            {
                Invoke(new Action(UpdateAccountInfo));
                return;
            }
        ...
        {
            checking.DepositAsync(amount); // This works because 'dynamic' allows handling different types
